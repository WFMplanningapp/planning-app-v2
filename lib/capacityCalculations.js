export const generateCapacity = (capPlan, entries, weeks, fromWeek) => {
  ...
  let newPlan = weeks.map((week) => {
    ...
    // Se reparares, para os cálculos de capacity isto tem o mesmo comportamento que Move Out
    // ou attrition.
    // A logica é 'se existe entry e entry.rampDown, entao reduz o total HC, o total FTE e o expected FTE em 1'
